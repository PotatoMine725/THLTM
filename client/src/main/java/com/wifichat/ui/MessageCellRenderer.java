...
public class MessageCellRenderer extends JPanel implements ListCellRenderer<ChatMessage> {
    ...
    public MessageCellRenderer(String localUserId) {
        ...
        bubblePanel = new BubblePanel(28);
        bubblePanel.setLayout(new BoxLayout(bubblePanel, BoxLayout.Y_AXIS));
        bubblePanel.setBorder(new EmptyBorder(10, 16, 10, 16)); 
    ...
    public Component getListCellRendererComponent(
        ...
        if (mine) {
            ...
            contentLabel.setText("<html><body style='max-width:" + contentWidth + "px; margin:0;'>" + content + "</body></html>");
            ...
            if (value.replyPreview() != null && !value.replyPreview().isBlank()) {
                ...
                replyLabel.setText("<html>&#x2514; <span style='color:" + UIHelper.colorToHex(AppTheme.TEXT_PRIMARY) + "'>" + TextUtils.htmlEscape(value.replyPreview()) + "</span></html>");
            ...
            if (value.replyPreview() != null && !value.replyPreview().isBlank()) {
                replyLabel.setVisible(true);
                replyLabel.setText("<html>&#x2514; <span style='color:" + UIHelper.colorToHex(AppTheme.TEXT_SECONDARY) + "'>" + TextUtils.htmlEscape(value.replyPreview()) + "</span></html>");
                replyLabel.setBorder(new EmptyBorder(0, 0, 4, 0));
            } else {
                replyLabel.setVisible(false);
            }
